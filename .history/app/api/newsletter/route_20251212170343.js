...
// Arcjet 2.x API createRemoteClient does NOT return the limiter function itself, 
// but rather a *client* object with its own API. Need to call client.limiter(...)!
// See https://docs.arcjet.com/reference/libraries/node-sdk#createRemoteClient
...
export async function POST(request) {
  try {
    ...
    // Arcjet Rate Limiting - use client.limiter() properly (not just client())
    let allowed = true;
    try {
