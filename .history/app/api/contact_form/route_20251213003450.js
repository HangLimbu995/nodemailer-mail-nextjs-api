...
export async function POST(request) {
  try {
    ...
    if(!senderEmail, !pass, !receiverEmail) {
        console.error("Missing email enviornment variables!")
    }
           ...
           ${himalayaBanner}
            ...
            <div style="padding: 32px 33px 27px 33px;">
              ...
              <div style="font-size: 13px; color: #bba95a;">
                This is an automated confirmation email from <span style="background-image:linear-gradient(to right,#F9CB00,#E2792B);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;text-fill-color:transparent;">HimalayaFace</span>. No further action is needed at this time.
              </div>
            </div>
          </div>
        </div>
